<template>
    <div class=" px-1 my-1" >
        ...
        <div @click="setSelectedMessage(chat)" v-for="(chat, i) in listChat" :key="i" class="list-chat hover:bg-blue-200 hover:rounded-[5px] hover:p-1 cursor-pointer ">
                    ...
                    <div class="flex gap-[37px]">
                        ...
                        <div class="item-info w-full">
                            ...
                            <div class="grid grid-cols-2 w-full">
                                ...
                                <div class="ml-auto text-end rounded-full bg-[#EB5757] h-[10px] w-[10px]" v-if="chat.lastChatPreview.isNewMessage"></div>
                            </div>
                        </div>
                    </div>
                </div>
